...
final List<String> imgList = [
  'assets/Annapurna-South.jpg',
  'assets/Machapuchre.jpg',
  'assets/Jemluk_Bay_Bali.jpg',
  'assets/Goechala.jpg',
  'assets/Goechala_2.jpg',
  'assets/Goechala_Trail.JPG'
];
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Stack(children: <Widget>[
          ...
          Image(image: AssetImage(i),fit: BoxFit.cover, width: 1000.0,),
          Positioned(
            bottom: 0.0,
            left: 0.0,
            right: 0.0,
        ...
        (url) {
          return Container(
            ...
            child: ClipRRect(
              ...
              //   width: 1000.0,
              // ),
              child: Image(image: AssetImage(url), fit: BoxFit.cover, width:  1000.0,),
            ),
          );
        },
      ).toList(),
